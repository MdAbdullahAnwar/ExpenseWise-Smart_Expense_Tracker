...
const CTAButtons = () => (
  <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
    ...
    <button className="w-full sm:w-auto border-2 border-gray-300 dark:border-gray-600 hover:border-purple-600 dark:hover:border-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/10 px-8 py-4 rounded-lg font-semibold text-base transition-all duration-300 text-gray-900 dark:text-white">
      Login to Dashboard
    </button>
  </div>
);
...
const DashboardPreview = () => (
  <div className="mt-20 relative">
    ...
    <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-2 border border-gray-200 dark:border-gray-700">
      <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <DashboardCard 
            ...
            progress={{ width: "75%", gradient: "from-blue-500 to-purple-500" }}
          />
          <DashboardCard 
            icon={FileText}
            value="142"
            ...
            progress={{ width: "50%", gradient: "from-purple-500 to-pink-500" }}
          />
          <DashboardCard 
            icon={Target}
            value="85%"
            ...
            progress={{ width: "85%", gradient: "from-pink-500 to-red-500" }}
          />
        </div>
      </div>
    </div>
...
const TestimonialCard = ({ testimonial, isActive }) => (
  <div className={`bg-white dark:bg-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border cursor-pointer ${
    isActive 
      ...
      : 'border-purple-100 dark:border-purple-800 hover:border-purple-300'
  }`}>
...
const PricingCard = ({ plan }) => (
  <div className={`relative p-8 rounded-2xl transition-all duration-300 hover:scale-105 cursor-pointer ${
    plan.highlighted
      ...
      : "bg-gradient-to-br from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 border-2 border-gray-200 dark:border-gray-600 hover:border-purple-500 dark:hover:border-purple-400 shadow-lg"
  }`}>
    {plan.highlighted && (
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="flex justify-center gap-2 mt-8">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 hover:bg-purple-500 ${
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-700 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="bg-white text-blue-700 hover:bg-gray-50 shadow-2xl px-8 py-4 rounded-lg font-semibold hover:scale-105 transition-all duration-300 inline-flex items-center group">
